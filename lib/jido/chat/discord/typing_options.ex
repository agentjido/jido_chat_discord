defmodule Jido.Chat.Discord.TypingOptions do
  @moduledoc """
  Typed options for Discord `start_typing/2`.
  """
  ...
  @schema Zoi.struct(
            ...
            %{
              ...
              nostrum_channel_api: Zoi.any() |> Zoi.nullish()
            },
            coerce: true
          )
  ...
  def transport_opts(%__MODULE__{} = opts) do
    []
    |> maybe_kw(:status, opts.status)
    |> maybe_kw(:nostrum_channel_api, opts.nostrum_channel_api)
  end
